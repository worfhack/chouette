    ...
    <div className="min-h-screen bg-[#FAF8F5]">
            ...
            <div>
              ...
              <div className="space-y-6">
                <div className="flex items-start gap-4">
                  ...
                  <div>
                    <h3 className="font-serif text-xl text-gray-900 mb-2">Vision d'Excellence</h3>
                    <p className="text-gray-600">Une quête incessante de la perfection dans l'art de la gemmologie, établissant les standards les plus élevés de l'industrie.</p>
                  </div>
                </div>
                <div className="flex items-start gap-4">
                  <div className="w-12 h-12 flex items-center justify-center bg-gray-900 rounded-full flex-shrink-0">
                  ...
                  <div>
                    <h3 className="font-serif text-xl text-gray-900 mb-2">Savoir Ancestral</h3>
                    <p className="text-gray-600">Des décennies d'expérience accumulées, combinant techniques traditionnelles et connaissances scientifiques modernes.</p>
                  </div>
                </div>
                <div className="flex items-start gap-4">
                  <div className="w-12 h-12 flex items-center justify-center bg-gray-900 rounded-full flex-shrink-0">
                  ...
                  <div>
                    <h3 className="font-serif text-xl text-gray-900 mb-2">Passion Transmise</h3>
                    <p className="text-gray-600">Un amour profond pour les pierres précieuses, partagé et transmis à la génération suivante avec dévouement.</p>
                  </div>
                </div>
              </div>
            </div>
      ...
      <section className="py-20 px-6 lg:px-12 bg-white">
        <div className="max-w-7xl mx-auto">
          <div className="grid lg:grid-cols-2 gap-16 items-center">
            ...
            <div className="relative h-[600px] rounded-lg overflow-hidden order-1 lg:order-2">
              <img
      ...
      <section className="py-32 px-6 lg:px-12 bg-gray-900 text-white">
        <div className="max-w-4xl mx-auto text-center">
          <i className="ri-double-quotes-l text-5xl text-gray-600 mb-8 block"></i>
      ...
      <section className="py-20 px-6 lg:px-12">
        <div className="max-w-5xl mx-auto">
          <h2 className="font-serif text-4xl text-gray-900 text-center mb-16">Notre Parcours</h2>
          <div className="space-y-12">
            <div className="flex gap-8 items-start">
              <div className="flex-shrink-0 w-32 text-right">
                <span className="font-serif text-2xl text-gray-900">1985</span>
              </div>
              <div className="flex-shrink-0 w-4 h-4 bg-gray-900 rounded-full mt-2"></div>
              <div className="flex-1">
                <h3 className="font-serif text-2xl text-gray-900 mb-2">Fondation de l'Atelier</h3>
                <p className="text-gray-700">Création de l'atelier par le père fondateur, animé par sa passion pour les pierres précieuses et son désir de partager son expertise.</p>
              </div>
            </div>
            <div className="flex gap-8 items-start">
              <div className="flex-shrink-0 w-32 text-right">
                <span className="font-serif text-2xl text-gray-900">1995</span>
              </div>
              <div className="flex-shrink-0 w-4 h-4 bg-gray-900 rounded-full mt-2"></div>
              <div className="flex-1">
                <h3 className="font-serif text-2xl text-gray-900 mb-2">Reconnaissance Internationale</h3>
                <p className="text-gray-700">L'atelier gagne en notoriété auprès des collectionneurs et investisseurs internationaux grâce à son expertise reconnue.</p>
              </div>
            </div>
            <div className="flex gap-8 items-start">
              <div className="flex-shrink-0 w-32 text-right">
                <span className="font-serif text-2xl text-gray-900">2010</span>
              </div>
              <div className="flex-shrink-0 w-4 h-4 bg-gray-900 rounded-full mt-2"></div>
              <div className="flex-1">
                <h3 className="font-serif text-2xl text-gray-900 mb-2">Transmission Familiale</h3>
                <p className="text-gray-700">Les fils rejoignent l'atelier après leurs formations en gemmologie, apportant un souffle nouveau tout en préservant les valeurs familiales.</p>
              </div>
            </div>
            <div className="flex gap-8 items-start">
              <div className="flex-shrink-0 w-32 text-right">
                <span className="font-serif text-2xl text-gray-900">2024</span>
              </div>
              <div className="flex-shrink-0 w-4 h-4 bg-gray-900 rounded-full mt-2"></div>
              <div className="flex-1">
                <h3 className="font-serif text-2xl text-gray-900 mb-2">Excellence Continue</h3>
                <p className="text-gray-700">Deux générations travaillent ensemble, combinant tradition et innovation pour offrir un service d'exception à une clientèle internationale.</p>
              </div>
            </div>
          </div>
        </div>
