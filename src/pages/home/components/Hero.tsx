    ...
    <section className="relative min-h-screen flex items-center justify-center overflow-hidden">
      ...
      <div className="relative z-10 w-full max-w-5xl mx-auto px-6 text-center">
        ...
        <div className="flex flex-col sm:flex-row gap-4 justify-center items-center">
          <a
            href="/rendez-vous"
            className="px-8 py-4 bg-white text-gray-900 font-medium text-sm tracking-wider hover:bg-gray-100 transition-all duration-300 cursor-pointer whitespace-nowrap rounded-sm"
          >
            PRENDRE RENDEZ-VOUS
          </a>
          <a
            href="/expertise"
            className="px-8 py-4 border-2 border-white text-white font-medium text-sm tracking-wider hover:bg-white hover:text-gray-900 transition-all duration-300 cursor-pointer whitespace-nowrap rounded-sm"
          >
